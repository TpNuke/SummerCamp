//MEMOIZATION
 public class FrogTab {
  ...
  public static void main(String[] args) {
      ...
      FrogTab tbfrog = new FrogTab(a);
      int result = tbfrog.f(n - 1); // Calculate the maximum energy required to reach the last step
